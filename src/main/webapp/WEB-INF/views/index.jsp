                                 ...
                                 <div class="row">
                                    <div class="col-md-12 col-lg-7">
                                       <div class="text-bg">
                                          ...
                                          <a class="read_more" href="#"><img src="<%=request.getContextPath() %>/resources/images/btn_h.png" alt="#"/> Discover Now</a>
                                       </div>
                                    </div>
            ...
            <div class="row">
               ...
               <div class="col-md-8 offset-md-2">
                  <div class="bitcoins_main">
                     <figure><img src="<%=request.getContextPath() %>/resources/images/bitcoins.jpg" alt="#"/></figure>
            ...
            <div class="row">
               ...
               <div class="col-md-8 offset-md-2">
                  <div class="wallet_main">
                     <figure><img src="<%=request.getContextPath() %>/resources/images/wallet.jpg" alt="#"/></figure>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-3 col-md-6 col-sm-6">
                     <a class="logo2" href="index.html"><img src="<%=request.getContextPath() %>/resources/images/loogo2.png" alt="#"/></a>
                     <div class="follow">
