...
<html lang="en">
   <head>
      ...
      <!-- fevicon -->
      <link rel="icon" href="<%=request.getContextPath() %>/resources/images/fevicon.png" type="<%=request.getContextPath() %>/image/gif" />
                                 ...
                                 <div class="row">
                                    <div class="col-md-12 col-lg-7">
                                       <div class="text-bg">
                                          ...
                                          <a class="read_more" href="#"><img src="images/btn_h.png" alt="#"/> Discover Now</a>
                                       </div>
                                    </div>
            ...
            <div class="row">
               ...
               <div class="col-md-8 offset-md-2">
                  <div class="bitcoins_main">
                     <figure><img src="images/bitcoins.jpg" alt="#"/></figure>
            ...
            <div class="row">
               ...
               <div class="col-md-8 offset-md-2">
                  <div class="wallet_main">
                     <figure><img src="images/wallet.jpg" alt="#"/></figure>
