                                 ...
                                 <div class="row">
                                    <div class="col-md-12 col-lg-7">
                                       <div class="text-bg">
                                          ...
                                          <a class="read_more" href="#"><img src="../resources/images/btn_h.png" alt="#"/> Discover Now</a>
                                       </div>
                                    </div>
                                    <div class="col-md-12 col-lg-5">
                                       <div class="text_img">
                                          <figure><img src="../resources/images/ban_img.png" alt="#"/></figure>
                                       </div>
                                    </div>
                                 </div>
                              </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-8 offset-md-2">
                  <div class="titlepage">
                     <h2> <span class="yellow">Buy and Sell Bitcoins</span><br>Why are so many people investing in digital </h2>
                  </div>
               </div>
               <div class="col-md-8 offset-md-2">
                  <div class="bitcoins_main">
                     <figure><img src="../resources/images/bitcoins.jpg" alt="#"/></figure>
            ...
            <div class="row">
               ...
               <div class="col-md-8 offset-md-2">
                  <div class="wallet_main">
                     <figure><img src="../resources/images/wallet.jpg" alt="#"/></figure>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-3 col-md-6 col-sm-6">
                     <a class="logo2" href="index.jsp"><img src="../resources/images/loogo2.png" alt="#"/></a>
                     <div class="follow">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                     <h3>Quick link</h3>
                     <ul class="link_icon">
                        <li class="active"> <a href="#"> <i class="fa fa-chevron-right" aria-hidden="index.jsp"></i>Home</a></li>
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                     ...
                     <div class="follow">
                        ...
                        <ul class="social_icon">
                           ...
                           <li> <a href="https://github.com/Jiyoooon/probono"><i class="fa fa-github"></i></a></li>
